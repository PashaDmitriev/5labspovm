...
void *read_thread(void* thr_par){
	char fileName[3][50] = {"/home/pavel/Desktop/1.txt","/home/pavel/Desktop/2.txt","/home/pavel/Desktop/3.txt"};
	mode_t mode = S_IRUSR;
...
void *write_thread(void* thr_par){
	char fileName[50] = "/home/pavel/Desktop/result.txt";
	mode_t mode = S_IWUSR;
...
int main(void) {
	...
	handle = dlopen("/home/pavel/Desktop/libDLL.so", RTLD_NOW);
	if (!handle) {
